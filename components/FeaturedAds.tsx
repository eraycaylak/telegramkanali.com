    ...
    useEffect(() => {
        async function loadAds() {
            try {
                ...
                // Return all active ads or limit to maxAds if explicitly provided as a small number
                setAds(maxAds < 100 ? shuffledData.slice(0, maxAds) : shuffledData);
            } catch (error) {
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0 pr-14">
                                    ...
                                    <div className="text-[11px] text-gray-500 truncate mt-0.5">
                                        {ad.channels?.member_count ? ad.channels.member_count.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") : '0'} üye
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-sm">
                                            {ad.channels?.member_count ? ad.channels.member_count.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") : '0'} üye · {ad.channels?.description?.substring(0, 60)}
                                        </p>
                                    </div>
                                </div>
