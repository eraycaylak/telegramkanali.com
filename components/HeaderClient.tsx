        ...
        <header className="flex flex-col w-full text-white font-sans relative z-50">
            ...
            <div className="bg-[#E30613] py-3 md:py-4 relative z-20 shadow-md">
                <div className="container mx-auto px-3 md:px-6 flex items-center justify-between gap-2 md:gap-4 overflow-hidden">
                    ...
                    <div className="flex-1 flex justify-center md:flex-none md:justify-start min-w-0">
                        <div className="flex items-center gap-2 md:gap-3 min-w-0">
                            <Link href="/" className="scale-90 md:scale-100 origin-center block flex-shrink-0">
                                {logo}
                            </Link>
                            {/* Başsağlığı Bandı — mobilde gizle, header taşmasını önle */}
                            <div className="hidden md:flex items-center gap-1.5 bg-black/25 border border-white/20 rounded-lg px-2 py-1 md:px-3 md:py-1.5 backdrop-blur-sm">
