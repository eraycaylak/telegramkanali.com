...
import {
    Users, Tv, TrendingUp, ArrowUpRight, Coins
} from 'lucide-react';
...
export default function DashboardOverviewClient({
    ...
    const cards = [
        { name: 'Kanallarım', value: channels, icon: Tv, shadow: 'shadow-blue-100', text: 'text-blue-600', bg: 'bg-blue-50' },
        { name: 'Jeton Bakiyem', value: `💰 ${balance.toLocaleString()}`, icon: Coins, shadow: 'shadow-green-100', text: 'text-green-600', bg: 'bg-green-50' },
        { name: 'Toplam Üye', value: totalMembers.toLocaleString(), icon: Users, shadow: 'shadow-purple-100', text: 'text-purple-600', bg: 'bg-purple-50' },
        { name: 'Aktif Reklamlar', value: activeAds, icon: TrendingUp, shadow: 'shadow-orange-100', text: 'text-orange-600', bg: 'bg-orange-50' },
    ];
        ...
        <div className="space-y-10">
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm overflow-hidden relative min-h-[300px] flex flex-col">
                <div className="flex items-center justify-between mb-8">
                    ...
                    {channels > 0 && (
                        <Link href="/dashboard/stats" className="text-sm font-bold text-blue-600 hover:underline flex items-center gap-1">
                            Detaylı İstatistikler <ArrowUpRight size={14} />
                        </Link>
                    )}
                </div>
